...
func RunTask(ctx context.Context, tasks ...TaskE) error {
	return defaultTaskGroup.RunTask(ctx, defaultGrPool, tasks...)
}

func (*TaskGroup) RunTask(ctx context.Context, pool *GrPool, tasks ...TaskE) error {
	_, err := runTaskE(ctx, pool, SerialDispatch, BreakByError, tasks...)
	return err
}
...
func (*TaskGroup) CRunTask(pool *GrPool, ctx context.Context, tasks ...TaskE) error {
	_, err := runTaskE(ctx, pool, ConcurrentDispatch, BreakByError, tasks...)
	return err
}
...
func CRunTaskE(ctx context.Context, tasks ...TaskE) (timeout bool, errs error) {
	return defaultTaskGroup.CRunTaskE(ctx, defaultGrPool, tasks...)
}

func (*TaskGroup) CRunTaskE(ctx context.Context, pool *GrPool, tasks ...TaskE) (timeout bool, errs error) {
	return runTaskE(ctx, pool, ConcurrentDispatch, NoBreak, tasks...)
}

func runTaskE(ctx context.Context, pool *GrPool, dtype DispatchType, isBreak bool, tasks ...TaskE) (timeout bool, errs error) {
